 ...
 */
export const postProcessByIdentifierKill = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<PostProcessByIdentifierKillData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostProcessByIdentifierKillResponse, PostProcessByIdentifierKillError, ThrowOnError>({
        ...options,
