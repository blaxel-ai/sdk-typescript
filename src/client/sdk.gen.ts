...
/**
 * List UVM
 * Returns a list of all UVMs in the workspace.
 */
export const listUvm = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<ListUvmResponse, ListUvmError, ThrowOnError>({
        ...options,
        url: '/compute/uvm'
    });
};
 ...
 * Creates a UVM.
 */
export const createUvm = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateUvmData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateUvmResponse, CreateUvmError, ThrowOnError>({
        ...options,
        url: '/compute/uvm'
    });
};
...
/**
 * Delete UVM
 * Deletes a UVM by name.
 */
export const deleteUvm = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteUvmData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteUvmResponse, DeleteUvmError, ThrowOnError>({
        ...options,
        url: '/compute/uvm/{uvmName}'
    });
};

/**
 * Get UVM
 * Returns a UVM by name.
 */
export const getUvm = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetUvmData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetUvmResponse, GetUvmError, ThrowOnError>({
        ...options,
        url: '/compute/uvm/{uvmName}'
    });
};
...
/**
 * Update UVM
 * Update a UVM by name.
 */
export const updateUvm = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateUvmData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateUvmResponse, UpdateUvmError, ThrowOnError>({
        ...options,
        url: '/compute/uvm/{uvmName}'
    });
};
...
/**
 * Start UVM
 * Starts a UVM by name.
 */
export const startUvm = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<StartUvmData, ThrowOnError>) => {
    return (options?.client ?? client).put<StartUvmResponse, StartUvmError, ThrowOnError>({
        ...options,
        url: '/compute/uvm/{uvmName}/start'
    });
};
 ...
 * Stops a UVM by name.
 */
export const stopUvm = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<StopUvmData, ThrowOnError>) => {
    return (options?.client ?? client).put<StopUvmResponse, StopUvmError, ThrowOnError>({
        ...options,
        url: '/compute/uvm/{uvmName}/stop'
    });
};
...
export const listUvmHubDefinitions = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<ListUvmHubDefinitionsResponse, ListUvmHubDefinitionsError, ThrowOnError>({
        ...options,
        url: '/uvm/hub'
    });
};
