...
export const listSandboxHubDefinitions = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<ListSandboxHubDefinitionsResponse, ListSandboxHubDefinitionsError, ThrowOnError>({
        ...options,
        url: '/sandbox/hub'
    });
};
 ...
 */
export const listSandboxes = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<ListSandboxesResponse, ListSandboxesError, ThrowOnError>({
        ...options,
        url: '/sandboxes'
    });
};
 ...
 * Creates a Sandbox.
 */
export const createSandbox = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateSandboxData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateSandboxResponse, CreateSandboxError, ThrowOnError>({
        ...options,
        url: '/sandboxes'
    });
};
 ...
 */
export const deleteSandbox = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteSandboxData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteSandboxResponse, DeleteSandboxError, ThrowOnError>({
        ...options,
 ...
 */
export const getSandbox = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetSandboxData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetSandboxResponse, GetSandboxError, ThrowOnError>({
        ...options,
        url: '/sandboxes/{sandboxName}'
    });
};
 ...
 */
export const updateSandbox = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateSandboxData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateSandboxResponse, UpdateSandboxError, ThrowOnError>({
        ...options,
        url: '/sandboxes/{sandboxName}'
    });
};
 ...
 */
export const startSandbox = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<StartSandboxData, ThrowOnError>) => {
    return (options?.client ?? client).put<StartSandboxResponse, StartSandboxError, ThrowOnError>({
        ...options,
 ...
 */
export const stopSandbox = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<StopSandboxData, ThrowOnError>) => {
    return (options?.client ?? client).put<StopSandboxResponse, StopSandboxError, ThrowOnError>({
        ...options,
