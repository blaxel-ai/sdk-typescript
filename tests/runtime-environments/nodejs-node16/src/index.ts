...
async function testWebSocket() {
  console.log("🔌 Testing WebSocket functionality in Node16...");
...
async function main() {
  ...
  if (wsTestPassed) {
    console.log("✅ WebSocket functionality verified in Node16");
  } else {
    console.log("❌ WebSocket functionality failed in Node16");
    process.exit(1);
  }
}
