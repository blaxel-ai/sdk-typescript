 ...
 */
export const getSandboxPreviewTokens = <ThrowOnError extends boolean = false>(options: Options<GetSandboxPreviewTokensData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetSandboxPreviewTokensResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
