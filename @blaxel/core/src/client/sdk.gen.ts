...
import type { AcceptWorkspaceInvitationData, AcceptWorkspaceInvitationResponse, CheckWorkspaceAvailabilityData, CheckWorkspaceAvailabilityResponse, CreateAgentData, CreateAgentResponse, CreateApiKeyForServiceAccountData, CreateApiKeyForServiceAccountResponse, CreateFunctionData, CreateFunctionResponse, CreateIntegrationConnectionData, CreateIntegrationConnectionResponse, CreateKnowledgebaseData, CreateKnowledgebaseResponse, CreateModelData, CreateModelResponse, CreatePolicyData, CreatePolicyResponse, CreatePrivateClusterData, CreatePrivateClusterResponse, CreateSandboxData, CreateSandboxResponse, CreateWorkspaceServiceAccountData, CreateWorkspaceServiceAccountResponse, CreateWorspaceData, CreateWorspaceResponse, DeclineWorkspaceInvitationData, DeclineWorkspaceInvitationResponse, DeleteAgentData, DeleteAgentResponse, DeleteApiKeyForServiceAccountData, DeleteFunctionData, DeleteFunctionResponse, DeleteIntegrationConnectionData, DeleteIntegrationConnectionResponse, DeleteKnowledgebaseData, DeleteKnowledgebaseResponse, DeleteModelData, DeleteModelResponse, DeletePolicyData, DeletePolicyResponse, DeletePrivateClusterData, DeletePrivateClusterResponse, DeleteSandboxData, DeleteSandboxResponse, DeleteWorkspaceData, DeleteWorkspaceResponse, DeleteWorkspaceServiceAccountData, DeleteWorkspaceServiceAccountResponse, GetAgentData, GetAgentResponse, GetConfigurationData, GetConfigurationResponse, GetFunctionData, GetFunctionResponse, GetIntegrationConnectionData, GetIntegrationConnectionModelData, GetIntegrationConnectionModelEndpointConfigurationsData, GetIntegrationConnectionResponse, GetIntegrationData, GetKnowledgebaseData, GetKnowledgebaseResponse, GetModelData, GetModelResponse, GetPolicyData, GetPolicyResponse, GetPrivateClusterData, GetPrivateClusterHealthData, GetPrivateClusterResponse, GetSandboxData, GetSandboxResponse, GetTemplateContentsData, GetTemplateContentsResponse, GetTemplateData, GetTemplateFileContentsData, GetTemplateFileContentsResponse, GetTemplateResponse, GetWorkspaceData, GetWorkspaceResponse, GetWorkspaceServiceAccountsData, GetWorkspaceServiceAccountsResponse, InviteWorkspaceUserData, InviteWorkspaceUserResponse, LeaveWorkspaceData, LeaveWorkspaceResponse, ListAgentRevisionsData, ListAgentRevisionsResponse, ListAgentsData, ListAgentsResponse, ListAllPendingInvitationsData, ListAllPendingInvitationsResponse, ListApiKeysForServiceAccountData, ListApiKeysForServiceAccountResponse, ListFunctionRevisionsData, ListFunctionRevisionsResponse, ListFunctionsData, ListFunctionsResponse, ListIntegrationConnectionModelsData, ListIntegrationConnectionsData, ListIntegrationConnectionsResponse, ListKnowledgebaseRevisionsData, ListKnowledgebaseRevisionsResponse, ListKnowledgebasesData, ListKnowledgebasesResponse, ListLocationsData, ListLocationsResponse, ListMcpHubDefinitionsData, ListMcpHubDefinitionsResponse, ListModelRevisionsData, ListModelRevisionsResponse, ListModelsData, ListModelsResponse, ListPoliciesData, ListPoliciesResponse, ListPrivateClustersData, ListPrivateClustersResponse, ListSandboxHubDefinitionsData, ListSandboxHubDefinitionsResponse, ListSandboxesData, ListSandboxesResponse, ListTemplatesData, ListTemplatesResponse, ListWorkspaceUsersData, ListWorkspaceUsersResponse, ListWorkspacesData, ListWorkspacesResponse, RemoveWorkspaceUserData, StartSandboxData, StartSandboxResponse, StopSandboxData, StopSandboxResponse, UpdateAgentData, UpdateAgentResponse, UpdateFunctionData, UpdateFunctionResponse, UpdateIntegrationConnectionData, UpdateIntegrationConnectionResponse, UpdateKnowledgebaseData, UpdateKnowledgebaseResponse, UpdateModelData, UpdateModelResponse, UpdatePolicyData, UpdatePolicyResponse, UpdatePrivateClusterData, UpdatePrivateClusterHealthData, UpdatePrivateClusterResponse, UpdateSandboxData, UpdateSandboxResponse, UpdateWorkspaceData, UpdateWorkspaceResponse, UpdateWorkspaceServiceAccountData, UpdateWorkspaceServiceAccountResponse, UpdateWorkspaceUserRoleData, UpdateWorkspaceUserRoleResponse } from './types.gen.js';
