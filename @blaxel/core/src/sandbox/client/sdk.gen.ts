 ...
 */
export const postArchiveExport = <ThrowOnError extends boolean = false>(options: Options<PostArchiveExportData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostArchiveExportResponse, PostArchiveExportError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const postArchiveResume = <ThrowOnError extends boolean = false>(options?: Options<PostArchiveResumeData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostArchiveResumeResponse, PostArchiveResumeError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const getArchiveStatus = <ThrowOnError extends boolean = false>(options?: Options<GetArchiveStatusData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetArchiveStatusResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const getDrivesMount = <ThrowOnError extends boolean = false>(options?: Options<GetDrivesMountData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetDrivesMountResponse, GetDrivesMountError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const deleteDrivesMountByMountPath = <ThrowOnError extends boolean = false>(options: Options<DeleteDrivesMountByMountPathData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteDrivesMountByMountPathResponse, DeleteDrivesMountByMountPathError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const postEnvironmentReload = <ThrowOnError extends boolean = false>(options?: Options<PostEnvironmentReloadData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostEnvironmentReloadResponse, PostEnvironmentReloadError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const deleteNetworkTunnel = <ThrowOnError extends boolean = false>(options?: Options<DeleteNetworkTunnelData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).delete<DeleteNetworkTunnelResponse, DeleteNetworkTunnelError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const putNetworkTunnelConfig = <ThrowOnError extends boolean = false>(options: Options<PutNetworkTunnelConfigData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<PutNetworkTunnelConfigResponse, PutNetworkTunnelConfigError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const deleteProcessByIdentifierStdin = <ThrowOnError extends boolean = false>(options: Options<DeleteProcessByIdentifierStdinData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteProcessByIdentifierStdinResponse, DeleteProcessByIdentifierStdinError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const postProcessByIdentifierStdin = <ThrowOnError extends boolean = false>(options: Options<PostProcessByIdentifierStdinData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostProcessByIdentifierStdinResponse, PostProcessByIdentifierStdinError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
